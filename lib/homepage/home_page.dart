...
import 'package:flutteruiapp/homepage/menu_bloc.dart';
import 'package:flutteruiapp/homepage/menu.dart';
import 'package:flutteruiapp/homepage/about_tile.dart';
import 'package:flutteruiapp/homepage/profile_tile.dart';
...
class HomePage extends StatelessWidget {
  ...
  HomePage({Key key, this.empID,this.name,this.email,this.photo}) : super(key: key);
